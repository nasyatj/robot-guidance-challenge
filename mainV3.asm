...
;--------------------------------------------------------------------------------------------
A_THRESH       EQU   $C0                       ; Path detection threshold
B_THRESH       EQU   $CA                       ; ""
C_THRESH       EQU   $CA                       ; ""
D_THRESH       EQU   $CA                       ; ""

E_THRESH       EQU   $60                       ; If SENSOR_LINE < E_THRESH robot must shift right
F_THRESH       EQU   $B4                       ; If SENSOR_LINE > F_THRESH robot must shift left
